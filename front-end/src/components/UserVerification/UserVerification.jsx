...
const UserVerification = () => {
    ...
    const handleVerification = async () => {
        ...
        if (v_code === '' || v_code === null) {
            ...
            const response = await fetch("https://rentify-backend-olive.vercel.app/api/verification/verify",{
                method: "POST",
    ...
    const handleRetry = async() => {
        setLoading(true)
        try {
            await fetch(`https://rentify-backend-olive.vercel.app/api/verification/retry/${formData.email}`)
